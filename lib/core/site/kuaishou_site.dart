...
class KuaishowSite implements LiveSite {
  ...
  Future<bool> getLiveStatus({required String platform, required String roomId}) async {
    ...
    final room = await _loadRoom(roomId, includePlaybackData: false, ensureSession: false)
        .catchError((_) => _loadRoom(roomId, includePlaybackData: false, ensureSession: true));
